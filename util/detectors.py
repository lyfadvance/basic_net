#coding:utf-8
import numpy as np
from gpu_nms import gpu_nms as nms
...
class TextDetector:
    def __init__(self):
        self.mode= TextLinecfg.TEST.DETECT_MODE
        if self.mode == "H":
    ...
    def detect(self, text_proposals,scores,size):
        ...
        # 对proposal做nms
        keep_inds=nms(np.hstack((text_proposals, scores)), TextLineCfg.TEXT_PROPOSALS_NMS_THRESH,device_id=TextLineCfg.GPU_ID)
        text_proposals, scores=text_proposals[keep_inds], scores[keep_inds]
